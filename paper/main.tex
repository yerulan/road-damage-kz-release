...
\subsection{AI-Assisted Technical Support}

OpenAI Codex and ChatGPT were used for technical assistance during repository development, including code editing, command preparation, and LaTeX formatting. The tools were not used to make final data-inclusion decisions, annotation decisions, authorship decisions, scientific conclusions, or final manuscript decisions. All code changes, dataset rows, annotations, model results, numerical claims, and manuscript text were reviewed and approved by the authors.
...
\acknowledgments{The authors thank the maintainers of the RoadDamageDetector/RDD datasets and the open-license image communities whose metadata enables reproducible source auditing. During repository development and manuscript formatting, the authors used OpenAI Codex and ChatGPT for technical assistance with code editing, command preparation, and LaTeX formatting. The authors reviewed and edited the output and take full responsibility for the content of this publication.}
